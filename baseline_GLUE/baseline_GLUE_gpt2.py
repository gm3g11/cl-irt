...
models = ["gpt2"]
GLUE_TASKS = ["mrpc", "rte", "qnli", "qqp", "sst2", "mnli"]
GPU_avail = torch.cuda.is_available()
print("GPU_CUDA is available: ", GPU_avail)

# Directory to store results
output_dir = "glue_baseline_gpt2_3"
...
dev_batch_size = 256
num_epochs = 30  # Increase the number of epochs to allow more training
max_length = 128
num_workers = 4
    ...
    for model_checkpoint in models:
        ...
        for epoch in range(num_epochs):
            ...
            for step, batch in enumerate(tqdm(train_dataloader)):
                # Zero gradients each iteration (moved from model.zero_grad() to optimizer.zero_grad())
                optimizer.zero_grad()
        ...
        final_stats_filename = (
            f"{output_dir}/final_stats_{model_checkpoint}_{task}_"
